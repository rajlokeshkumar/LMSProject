...
private List<ExpenseOnTripBilled> expenseOnTripBilled;
...
public List<ExpenseOnTripBilled> getExpenseOnTripBilled() {
	return expenseOnTripBilled;
}

public void setExpenseOnTripBilled(List<ExpenseOnTripBilled> expenseOnTripBilled) {
